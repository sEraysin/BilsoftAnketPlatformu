    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserPersonel", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppUserPersonel_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppUserPersonel_Personel_PersonelID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppUserPersonel_PersonelID",
                table: "AppUserPersonel",
                column: "PersonelID");

            migrationBuilder.CreateIndex(
                name: "IX_AppUserPersonel_UserId_PersonelID",
                table: "AppUserPersonel",
                columns: new[] { "UserId", "PersonelID" },
                unique: true);
